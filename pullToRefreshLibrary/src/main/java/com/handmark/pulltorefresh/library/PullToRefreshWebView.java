...
//			webView = new MyDF_WebView(context, attrs);
		} else {
			webView = new MyDF_WebView(context, attrs);
		}
	...
	final class MyDF_WebView extends WebView{

		public MyDF_WebView(Context context) {
			super(context);
		}

		public MyDF_WebView(Context context, AttributeSet attrs) {
			super(context, attrs);
		}

		public MyDF_WebView(Context context, AttributeSet attrs, int defStyle) {
